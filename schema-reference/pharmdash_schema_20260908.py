...
class ProductCategory(str, Enum):
    cancer_med = "cancer med"
    glp = "glp"
    peptides = "experimental therapeutic peptides"
...
class DomainData(BaseModel):
    ...
    product_label: Optional[List[ProductCategory]] = None
    nabp_status: Optional[NabpStatus] = None
    fda_status: Optional[FDAStatus] = None
...
class SocialMediaData(BaseModel):
    ...
    product_list: Optional[List[ProductType]] = None
    contact_info: List[ContactInfoItem]
